    ...
    <section id="header-featured-image" class="container-fluid header-section-space header">
        <div class="container">
            <div class="col-md-10 column-center no-padding">
                <h1 class="center">FITNESS | HOME</h1>
            </div>
        </div>
    </section>
    <!--================================= HEADER-1 END =============================================-->
                ...
                ?>
                    <div class="row entry-meta lsb-br lsb-br-bottom">
                        <div class="col-md-6 image-bottom pos-rel">
                            <a href="single.php?productid=<?php echo $row["Id"]; ?>" ><img style="width:100%;height: 290px;" class="img-responsive" src="uploads/<?php echo $row["Image"]; ?>" alt="blog post"></a>
                        </div>
                        <div class="col-md-6">
                    ...
                    {
                        echo "<br><h4>Sorry, No Post Available</h4>";
                    }
                    //$conn->close();
                ?>
                </div>
